...
public class Thinning {
	...
	public BufferedImage ThinnedImage(BufferedImage img) {

		int[][] ImageData = doZhangSuenThinning(bufferedtoArr(img));
		img = ArrtoBuffered(ImageData, img);
		return img;

	}

	public static BufferedImage Thin(BufferedImage img) {
		Thinning thinOp = new Thinning();
		BufferedImage ThinnedImage = thinOp.ThinnedImage(img);
		return ThinnedImage;
	}

	private int[][] bufferedtoArr(BufferedImage image) {
	...
	private BufferedImage ArrtoBuffered(int[][] imageData, BufferedImage image) {
